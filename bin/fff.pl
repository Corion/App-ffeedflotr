...
$INC{__PACKAGE__}=$0;package main;
use strict;
use Getopt::Long;
#use App::Ffeedflotr; # inlined above
use vars qw($VERSION);
...
<!-- fetched from 'http://people.iola.dk/olau/flot/jquery.flot.js' -->
<script type="text/javascript">
...
<!-- fetched from 'http://people.iola.dk/olau/flot/jquery.flot.stack.js' -->
<script type="text/javascript">
/*
...
<!-- fetched from 'http://people.iola.dk/olau/flot/jquery.flot.fillbetween.js' -->
<script type="text/javascript">
/*
...
<!-- fetched from 'http://people.iola.dk/olau/flot/jquery.flot.pie.js' -->
<script type="text/javascript">
/*
...
function setupPlot(plotData) {
    $.plot("#plot1", plotData, plotConfig);
};
</script>
    
</head>
<body>
<div id="plot1" style="height:95%;">Here comes the plot</div>
</body>
</html>